...
# Define paths
silver_base_path = "abfss://fintech@fintechrg.dfs.core.windows.net/silver/fintech/"
output_base_path = "abfss://fintech@fintechrg.dfs.core.windows.net/gold/fintech/"

...
# Define paths
base_path = "abfss://fintech@fintechrg.dfs.core.windows.net/bronze/fintech/"
output_base_path = "abfss://fintech@fintechrg.dfs.core.windows.net/silver/fintech/"
